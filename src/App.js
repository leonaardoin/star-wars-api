      ...
      <div className="App">
        ...
        <Routes>
          <Route
            ...
            element={
              <Cards
                getStarWarData={API.getAllStarships}
                getInfoFromObject={starshipInfo}
              />
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <Cards
                getStarWarData={API.getAllPeople}
                getInfoFromObject={peopleInfo}
              />
            }
          />
          <Route
            ...
            element={
              <Cards
                getStarWarData={API.getAllPlanets}
                getInfoFromObject={planetInfo}
              />
            }
          />
